...
<<<<<<< HEAD
    try:
        ...
        print(f"Warning: Could not clear collection '{collection_id}'. Reason: {e}")


def clear_bucket(bucket_id):
    """
    Deletes all files in the specified storage bucket.
    """
    print(f"Clearing bucket: {bucket_id}")
